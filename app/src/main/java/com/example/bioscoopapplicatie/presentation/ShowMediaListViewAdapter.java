...
public class ShowMediaListViewAdapter extends RecyclerView.Adapter<ShowMediaListViewAdapter.MediaViewHolder> {
    private static final String TAG = ShowMediaListViewAdapter.class.getSimpleName();
    private List<Media> media;
    private LayoutInflater inflater;
    private Context context;

    public ShowMediaListViewAdapter(Context context) {
    ...
    class MediaViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MediaViewHolder(@NonNull View itemView) {
            ...
            title = itemView.findViewById(R.id.show_media_list_item_title_txt);
