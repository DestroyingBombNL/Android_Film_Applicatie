...
public class ShowMediaListMediaAdapter extends RecyclerView.Adapter<ShowMediaListMediaAdapter.MediaViewHolder> {
    private static final String TAG = ShowMediaListMediaAdapter.class.getSimpleName();
    private List<Media> media;
    private LayoutInflater inflater;
    private Context context;

    public ShowMediaListMediaAdapter(Context context) {
